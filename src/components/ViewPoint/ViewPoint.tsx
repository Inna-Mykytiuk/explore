...
const ViewPoint = () => {
  ...
  return (
    <section className="w-full mt-[100px]" id="view-point">
        ...
        <div className="w-[40%] flex flex-col gap-2 pl-[100px]">
          {[1, 2, 3, 4].map((item, index) => (
            <div
              ...
              } border-[6px] mr-[-50px] ml-[-100px] pl-[100px] pr-[100px] py-2 z-[99] relative cursor-pointer`}
            >
              <div className="text-white gap-10 flex group">
                <p className="text-[25px] font-semibold">2/07</p>
                <div>
                  <h3 className="text-[17px] font-[600]">Lorem ipsum dolor.</h3>
                  <p className="mt-2">
